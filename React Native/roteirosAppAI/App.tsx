...
import { View, Text, StyleSheet, TextInput, StatusBar, Platform, Pressable, ScrollView, ActivityIndicator, Alert, Keyboard } from 'react-native';
...
const KEY_GPT = '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'
  ...
  async function handleGenerate() {
    ...
    fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        temperature: 0.20,// Aumenta a precisão da resposta
        max_tokens: 500, // Quantidade de tokens 
        top_p: 1,
      })
    })
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.form}>
        ...
        <Text style={styles.label}>Tempo de estadia: <Text style={styles.days}> {days.toFixed(0)}</Text></Text>
